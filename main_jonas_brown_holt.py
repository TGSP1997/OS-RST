...
sine    = Input_Function(Input_Enum.SINE, [1, 0.4, 0, 0], sampling_period = step_size, point_counter = point_counter)
...
poly    = Input_Function(Input_Enum.POLYNOM, [100,-150,50,0], sampling_period = step_size)
